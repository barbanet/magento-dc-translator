...
class Dc_Translator_Block_Adminhtml_Package_Import_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('translator/adminhtml_package_import_tab_form')->toHtml(),
        ));
