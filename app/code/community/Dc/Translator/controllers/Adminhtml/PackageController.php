...
class Dc_Translator_Adminhtml_PackageController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function gridAction()
    {
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('translator/adminhtml_package_grid')->toHtml()
        );
    }
